...
\section{Sikkerhet}
\begin{itemize}
\item \textbf{Manuell utladning:} En trykknapp med 1 k$\Omega$ / 50 W motstand lar brukeren lade ut kondensatoren trygt på ~5 sekunder.
...
\item \textbf{LED-indikator:} En grønn LED med 220 k$\Omega$ / 1 W motstand lyser når spenningen overstiger ca. 200 V, og gir en visuell advarsel. **Merk: LED-en er ikke en pålitelig indikator for utladet tilstand.**
