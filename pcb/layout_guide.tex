...
\usepackage{tikz}
\title{PCB-layout – KONSEPTILLUSTRASJON (ikke produksjonsklar)}
\begin{document}
\maketitle
...
\textbf{Merk:} Dette er kun en prinsippskisse. Det endelige PCB-designet må lages i et EDA-verktøy og verifiseres.
\end{document}
